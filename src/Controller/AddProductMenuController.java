...
public class AddProductMenuController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        idTF.setText(String.valueOf(Inventory.getNewProductsId()));
    ...
    @FXML
    private void onActionCancelNewProduct(ActionEvent event) throws IOException {
        
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Cancel Adding New Product?");
    ...
    @FXML
    private void onActionSaveNewProduct(ActionEvent event) throws IOException {
